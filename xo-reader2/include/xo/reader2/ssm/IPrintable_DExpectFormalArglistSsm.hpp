...
See [xo-indentlog/xo/indentlog/pretty.hpp] **/
            static bool pretty_deprecated(const DExpectFormalArglistSsm & self, const ppindentinfo & ppii);
...
See [xo-ppsink/xo/ppsink/PpSink.hpp] **/
            static void pretty(const DExpectFormalArglistSsm & self, PpSink & sink);
