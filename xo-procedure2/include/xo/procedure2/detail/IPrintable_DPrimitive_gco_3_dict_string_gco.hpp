...
See [xo-indentlog/xo/indentlog/pretty.hpp] **/
            static bool pretty_deprecated(const DPrimitive_gco_3_dict_string_gco & self, const ppindentinfo & ppii);
...
See [xo-ppsink/xo/ppsink/PpSink.hpp] **/
            static void pretty(const DPrimitive_gco_3_dict_string_gco & self, PpSink & sink);
